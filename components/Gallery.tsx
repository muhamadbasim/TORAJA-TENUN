...
const items: WeaveItem[] = [
  // Kain Tenun Toraja
  {
    ...
    image: "https://i.imgur.com/KeuGg3c.jpeg"
  },
  {
    id: 2,
    title: "Pa'sekong",
    ...
    category: "Kain Tenun Toraja",
    image: "https://i.imgur.com/lN63oCP.jpeg"
  },
  {
    id: 3,
    title: "Pa'barre Allo",
    ...
    category: "Kain Tenun Toraja",
    image: "https://i.imgur.com/MIWfT43.jpeg"
  },
  {
    id: 4,
    title: "Ne' Limbongan",
    ...
    category: "Kain Tenun Toraja",
    image: "https://i.imgur.com/OItpUpe.jpeg"
  },
  // Tongkonan AYA TORAJA
  {
    id: 5,
    ...
    image: "https://i.imgur.com/B51yzzf.jpeg"
  },
  {
    id: 6,
    title: "Alang Sura'",
    ...
    category: "Tongkonan AYA TORAJA",
    image: "https://i.imgur.com/mfEFeoa.jpeg"
  },
  // Makanan Toraja
  {
    id: 7,
  ...
  // Ritual Rambu Solo
  {
    ...
    image: "https://i.imgur.com/sS0fQIT.jpeg"
  },
  {
    id: 10,
    title: "Tau Tau",
    ...
    pattern: "Ukiran Kayu",
    category: "Ritual Rambu Solo",
    image: "https://i.imgur.com/IepPYUu.jpeg"
  }
];
          ...
          <div className="flex flex-wrap gap-x-8 gap-y-4 border-b border-stone-200 pb-6">
            {categories.map((category) => (
              <button
                ...
                className={`text-lg md:text-xl serif transition-colors relative py-2 ${activeCategory === category
