...
const philosophySteps = [
  {
    ...
    image: "https://lh3.google.com/u/0/d/1tCFq0wkeREHthSJRRP_GVIF4gLOSq9xw=w1920-h988-iv1?auditContext=thumbnail&auditContext=prefetch" // User provided: Raw Fabric/Material
  },
  {
    id: 2,
    title: "Pewarna Alami",
    description: "Akar, daun, dan tanah liat diolah untuk menciptakan warna merah, hitam, dan kuning yang sakral.",
    image: "https://lh3.google.com/u/0/d/1bxG4ObZdPJzflFNzaXl5CuEec_WzlGKq=w1920-h988-iv1?auditContext=thumbnail&auditContext=prefetch" // Natural Cotton/Dye context
  },
  {
    id: 3,
    title: "Proses Tenun",
    description: "Irama alat tenun gedogan yang konstan, meniru detak jantung kehidupan dan ketekunan.",
    image: "https://lh3.google.com/u/0/d/1I1Ljh3hieeIMO1EXEEqB1k0Zz3iZAqyx=w1920-h988-iv1?auditContext=thumbnail&auditContext=prefetch" // Loom Weaving
  },
  {
    id: 4,
    title: "Simbol & Ritual",
    description: "Ukiran Pa'ssura dan kain tenun menyatu, menjadi elemen penting dalam upacara Rambu Solo' dan status sosial.",
    image: "https://lh3.google.com/u/0/d/1KNidgfGrYnGsZuRE7FjfLVXohjheblNx=w1920-h988-iv1?auditContext=thumbnail&auditContext=forDisplay" // Toraja Wood Carving (Pa'ssura) details
  }
];
