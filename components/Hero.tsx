      ...
      <div className="relative z-20 w-full px-6 flex flex-col items-center justify-center h-full mt-16">
        ...
        >
          ...
          <motion.p
            ...
            className="mt-8 text-lg md:text-xl text-emerald-950 font-medium max-w-2xl mx-auto bg-white/40 backdrop-blur-md p-6 rounded-xl border border-white/50 shadow-lg leading-relaxed italic"
          >
            "Di balik kabut pegunungan, tersembunyi kisah leluhur yang ditenun dalam setiap helai benang. Sebuah perjalanan visual melintasi waktu, dari megahnya Tongkonan hingga keabadian motif yang bernyawa."
          </motion.p>
        </motion.div>
      </div>
        ...
        >
          {[...Array(4)].map((_, i) => (
            <span key={i} className="text-7xl md:text-8xl font-serif italic mr-16 text-emerald-900">
              Warisan • Keabadian • Jiwa • Tradisi •
            </span>
          ))}
        </motion.div>
      </div>
